...
#include "ui_lcc_wallpaper.h"

//==========
//    PUBLIC
//==========
lcc_wallpaper::lcc_wallpaper() : QMainWindow(), ui(new Ui::lcc_wallpaper()) { ui->setupUi(this);
...
//    PUBLIC SLOTS
//================
void lcc_wallpaper::SaveSettings(){
...
void lcc_wallpaper::LoadSettings(int screennum){
...
void lcc_wallpaper::updateIcons(){
...
//        PRIVATE
//=================
QString lcc_wallpaper::getColorStyle(QString current, bool allowTransparency){
  QString out;
...
//    PRIVATE SLOTS
//=================
void lcc_wallpaper::updateMenus(){
...
void lcc_wallpaper::deskbgchanged(){
...
void lcc_wallpaper::deskbgcoloradded(){
...
void lcc_wallpaper::deskbgdiradded(){
...
void lcc_wallpaper::deskbgdirradded(){
